    ...
    <SectionHouseInfo>
      ...
      <HomePageInfo>
              <Text> <span>ЕкоГніздо Преміум</span> — це затишний і функціональний модульний будинок, створений для тих, хто цінує комфорт у мінімалістичному форматі. Площа 58 м² ідеально підходить для однієї людини чи пари, забезпечуючи все необхідне для щоденного життя.
                  <ul>
                      <li>Раціональне планування: простора кімната з можливістю облаштувати спальню, робочу зону або вітальню.</li>
                      <li>Затишна спальня: комфорт для відпочинку й відновлення.</li>
                      <li>Сучасний санвузол: повністю обладнаний для щоденного використання.</li>
                  ...
                  Ідеальний вибір для молодої пари, сім’ї з дитиною або як гостьовий будинок на вашій ділянці.
              </Text>
      </HomePageInfo>
    </SectionHouseInfo>
  );
