...
export default function HousePlan() {
  const images = [
    { src: "/images/housePremiumPage/Premium1.jpg", alt: "Вид спереду"  },
    { src: "/images/housePremiumPage/Premium2.jpg", alt: "Бічний фасад" },
    { src: "/images/housePremiumPage/Premium3.jpg", alt: "Задній фасад" },
  ];
    ...
    return (
        ...
        <Thumbnails>
          ...
          />
            ...
            <PlanSection>
                <h3>План будинку</h3>
                <img src="/images/housePremiumPage/housePlan.jpg" alt="План будинку" width="1036" height="611" />
            </PlanSection>

        <HousePriceInfo>
          <h2>Що входить у вартість будинку</h2>
          <FirstImage src="/images/housePremiumPage/FullInfoSection1.png" alt="Будинок"/>
          <SecondImage src="/images/housePremiumPage/FullInfoSection2.png" alt="Будинок"/>
          <FirstCardList>
