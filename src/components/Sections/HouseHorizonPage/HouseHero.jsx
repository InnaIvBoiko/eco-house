...
const SectionHeroHouse = styled.section`
  ...
  width: 1440px;
  height: 666px;
  background-image: url('/images/houseHorizonPage/house.jpg');
  ...
  h4 {
   ...
   color: #000;
    ...
    background-image: url('/images/houseHorizonPage/house-tab.jpg');
    width: 744px;
    height: 666px;
  ...
  @media (max-width: 743px){
    width: 320px;
    height: 350px;
    background-image: url('/images/houseHorizonPage/house-mob.jpg');
